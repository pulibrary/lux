            ...
            [
              n(
                ...
                [
                  ...
                  n(
                    "a",
                    { staticClass: "lux-app-name", attrs: { href: t.appUrl, title: t.appName } },
                    [
                      n("span", { staticClass: "full-name" }, [t._v(t._s(t.appName))]),
                      t._v(" "),
  ...
  oCYn: function(t, e, n) {
    ...
    ;(function(t) {
      ...
      function gr(t, e) {
        ...
        if (
          ...
          for (a in ((J || Q) && u.value !== c.value && yr(s, "value", u.value), c))
            r(u[a]) && (Fn(a) ? s.removeAttributeNS(Vn, Rn(a)) : zn(a) || s.removeAttribute(a))
        }
      }
      function yr(t, e, n) {
        t.tagName.indexOf("-") > -1
          ...
          if (!M || x || "" === x) {
            ...
            t.data.show ||
              ...
              z &&
                ...
                Ii(n, j),
                $i(function() {
                  Pi(n, D), H.cancelled || (Ii(n, A), N || (Bi(I) ? setTimeout(H, I) : zi(n, c, H)))
                })),
      ...
      function Gi(t, e, n) {
        ...
        if (!i || Array.isArray(r)) {
          for (var a, o, s = 0, c = t.options.length; s < c; s++)
            if (((o = t.options[s]), i))
              (a = I(r, Zi(o)) > -1), o.selected !== a && (o.selected = a)
      ...
      function aa(t) {
        ...
        return e && e.Ctor.options.abstract ? aa(qe(e.children)) : t
      }
      function oa(t) {
        var e = {},
          n = t.$options
      ...
      function ho(t, e) {
        ...
        ;(function(t) {
          ...
          (Ua = Tr(e.modules, "transformNode")),
          (qa = Tr(e.modules, "preTransformNode")),
      ...
      function vo(t, e) {
        ...
        for (var r = 0; r < Ua.length; r++) t = Ua[r](t, e) || t
        return (
          (function(t) {
            var e,
              n,
        ...
        Mo = {
          ...
          directives: {
            model: function(t, e, n) {
              ...
              else if (!Y.isReservedTag(a)) return Br(t, r, i), !1
              return !0
            },
            text: function(t, e) {
      ...
      function Ro(t, e) {
        ...
        if (t.for && !t.forProcessed) return qo(t, e)
      ...
      function qo(t, e, n, r) {
        ...
        return (
          (t.forProcessed = !0),
          (r || "_l") + "((" + i + "),function(" + a + o + s + "){return " + (n || Ro)(t, e) + "})"
        )
      }
      function Ko(t, e) {
        var n = "{",
      ...
      function Go(t, e) {
        ...
        if (t.for && !t.forProcessed) return qo(t, e, Go)
