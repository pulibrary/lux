 ...
 */
    ...
    FvBc: function(t, e, n) {
      ...
      var s = function(t) {
        ...
        c = Object(a.a)(r.a, o.a, o.b, !1, s, "data-v-ba672538", null)
      e.default = c.exports
    },
    Gu7T: function(t, e, n) {
      "use strict"
        ...
        s = (e.resourceModule = {
          ...
          mutations: {
            APPLY_STATE: function(t) {
              ;(t.resource.ogState = t.resource), (t.gallery.ogItems = t.gallery.items), (t.gallery.changeList = [])
            },
          ...
          getters: {
            ...
            stateChanged: function(t, e) {
              var n = []
              return (
                n.push(t.resource.ogState.thumbnail.id !== t.resource.thumbnail),
